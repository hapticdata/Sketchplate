        ...
        if( !isValidTemplate(ftch.target) ){
            ...
            async.series([
                function mkTemplatedir( cb ){
                    console.log('making template dir');
                    fs.mkdir(tmplDir, cb);
                },
                ...
                function remakeDir( cb ){
                    console.log('re-make the target directory: ' + ftch.target);
                    try {
